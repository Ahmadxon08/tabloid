  ...
  products.forEach((product) => {
    str += `
      <div class="card">
          ...
          <div class="changes">
          <div class="idcheck">
          <a href="" onclick="increment(${product.id})">-</a>
         ${product.id}
          <a href="" onclick="decrement(${product.id})">+</a></div>
         

          <div class="recheck">
          <a href="" onclik="removeFromCart(${product.id})">remove</a>
          <a href="">check out</a>
...
function increment(productId) {
  const product = cartProducts.map((pr) => pr.id === productId);
  const newProduct = {
    ...product,
